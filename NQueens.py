#AJEDREZ
#La reina es la pieza que se encuentra en su misma fila,columna.
...
#i:inicializacion
#Contiene el numero de reinas que iran en el tablero
NB_QUEENS = 10

#f(x):Evaluacion
# F.FITNESS
def evalNQueens(individual):
    """ El problema consiste en posiciones
    N reinas en un tablero de ajedrez de dimensiones NxN. 
    La función de evaluación calcula el número de reinas R que hay en cada diagonal. 
...
#Resultados de manera visual (graficamente) con la libreria matplotlib
#main devuelve la poblacion
